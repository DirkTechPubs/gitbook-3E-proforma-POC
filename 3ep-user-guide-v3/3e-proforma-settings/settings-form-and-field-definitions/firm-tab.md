...
| **Default proforma detail list view type**                    | Choose the default List view(i.e., Card or Grid) for card entries viewed in [Proforma Detail view](../../Getting-Started/Navigating-3E-Proforma---Walkthrough/Navigating-the-Proforma-Detail-View.md#navigating-the-proforma-detail-view).  |

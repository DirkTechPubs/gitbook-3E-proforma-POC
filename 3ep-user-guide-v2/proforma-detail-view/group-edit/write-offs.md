...
3. In the _Group Edit_ section, select the **Write Off Fees** or **Write Off Costs** check box. All cards of that type (i.e., Fees or Cards) will be written off and the individual cards will be updated in Proforma Details.
4. Click **Save & Close**.

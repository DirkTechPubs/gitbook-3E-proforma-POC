...
To access column settings, hover the mouse pointer over a column header and click the **Grid Menu** icon ![](../../.gitbook/assets/image36.png) .
...
1. Select the Grid Menu icon ![](../../.gitbook/assets/image36.png) and then click the **Column Filter** icon ![](../../.gitbook/assets/image35.png) .
...
**Note**: Any changes to the grid layout will be automatically saved for that user.  To reset the grid back to the stock settings, choose the Reset Columns option after clicking the ![](../../.gitbook/assets/image46.png) button.
...
Click the **Grouping** icon ![](../../.gitbook/assets/image34.png) to select and apply grouping criteria to the grid.
...
To see the cards within a grouping, click the down arrow ![](../../.gitbook/assets/image50.png) to expand the group. To collapse the group, click the up arrow ![](../../.gitbook/assets/image51.png) of the expanded group.
...
If you want to filter a list of cards, click the filter icon ![](../../.gitbook/assets/image53.png), the filter sidebar displays. Available filter criteria will vary by tab (i.e., Fees, Costs, Charges, etc.). See [Filters](filters.md#filters) for further details.

### _Sort List_

Select sort criteria from the **Sort** drop-down list. Sort criteria will vary by card tab. Click the **Sort** direction icon ![](../../.gitbook/assets/image29.png) to sort the list in ascending or descending order.
